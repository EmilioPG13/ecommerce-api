                ...
                <div className='md:w-1/2 p-8'>
                    ...
                    {product.stock_quantity > 0 && (
                        <div className='flex items-center mb-8'>
                            ...
                            <input 
                                ...
                                className='w-20 px-3 py-2 border rounded-md focus:ring-1 focus:ring-blue-500'
                            />
                        </div>
                    )}
                    ...
                    <button
                        ...
                        className={`w-full bg-blue-600 text-white px-6 py-3 rounded-md font-medium
                            ${(product.stock_quantity <= 0 || addingToCart) ? 'opacity-50 cursosr-not-allowed' : 'hover:bg-blue-700'}`}
                    >
