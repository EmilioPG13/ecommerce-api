    ...
    return (
        <div className='py-8 px-4'>
            <div className='max-w-md mx-auto bg-white rounded-lg shadow-md overflow-hidden p-6'>
                ...
                {submitError && (
                    <div className={`border px-4 py-3 rounded mb-4 ${submitError.type === 'success'
                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={handleChange}
                            className={`w-full px-3 py-2 border rounded-md ${errors.password ? 'border-redd-500' : 'border-gray-300'
                                } focus:outline-none focus:ring-1 focus:ring-blue-500`}
                        />
                        {error.password && (
                    ...
                    <div className='mt-6 grid grid-cols-2 gap-3'>
                        <div>
                            <button
                                ...
                                className='w-full flex justify-center py-2 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50'
                            >
                ...
                <div className='mt-6 text-center'>
                    <p className='text-gray-600'>
                        ...
                        <Link to='/register' className='text-blue-600 hover:undeline font-medium'>
                            Register
                        </Link>
                    </p>
                </div>
