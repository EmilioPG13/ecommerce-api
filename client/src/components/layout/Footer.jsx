                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link to="/products" className="text-gray-300 hover:text-white transition-colors">Featured Items</Link></li>
                            <li><Link to="/products" className="text-gray-300 hover:text-white transition-colors">New Arrivals</Link></li>
                            <li><Link to="/products" className="text-gray-300 hover:text-white transition-colors">Sale</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-2 flex">
                            <input 
                                ...
                                className="bg-gray-700 text-white px-3 py-2 rounded-l-md w-full focus:outline-none focus:ring-1 focus:ring-blue-500"
                            />
                            <button className="bg-blue-600 px-4 py-2 text-white rounded-r-md hover:bg-blue-700 transition-colors">
                                Sign Up
                            </button>
                        </div>
                    </div>
